...
test("general tab only uses the wide sticky layout when both width and height can support it", async () => {
  ...
  assert.match(raw, /@media \(min-width: 1320px\) and \(min-height: 900px\)\s*\{\s*\.vfl-general-side \.vfl-sticky-card/s);
});
